...
public class SharedAnchorControlPanel : MonoBehaviour
{
    ...
    private void SpawnTwinTurbineScene()
    {
        ...
        var networkedWindTurbine = PhotonPun.PhotonNetwork.Instantiate(TwinTurbine_windTurbine.name, new Vector3(spawnPoint.position.x,0, spawnPoint.position.z +3), spawnPoint.rotation);
